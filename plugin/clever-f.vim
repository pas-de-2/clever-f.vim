...
noremap <silent><expr><Plug>(clever-f-repeat-forward) clever_f#repeat_with_direction(0)
noremap <silent><expr><Plug>(clever-f-repeat-back)    clever_f#repeat_with_direction(1)
